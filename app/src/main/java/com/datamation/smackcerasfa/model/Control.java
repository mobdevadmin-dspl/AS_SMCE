...
public class Control {
    ...
    public String getFCONTROL_CON_BAKDATE() {
        return FCONTROL_CON_BAKDATE;
    }

    public void setFCONTROL_CON_BAKDATE(String FCONTROL_CON_BAKDATE) {
        this.FCONTROL_CON_BAKDATE = FCONTROL_CON_BAKDATE;
    }

    private String FCONTROL_CON_BAKDATE;
    ...
    public static Control parseControlDetails(JSONObject instance) throws JSONException, NumberFormatException {
        ...
        if(instance != null) {
                ...
                ctrl.setFCONTROL_SYSTYPE(instance.getString("SysType"));
                ctrl.setFCONTROL_CON_BAKDATE(instance.getString("conBackDate"));
                ctrl.setFCONTROL_SALESACC(instance.getString("salesacc"));
