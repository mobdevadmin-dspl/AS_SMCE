...
public class Debtor {
    ...
    public static Debtor parseOutlet(JSONObject instance) throws JSONException {
        ...
        if (instance != null) {
            ...
            aDebtor.setFDEBTOR_ADD_MACH(instance.getString("AddMach"));
            aDebtor.setFDEBTOR_ADD_USER(instance.getString("AddUser"));
            aDebtor.setFDEBTOR_DEAL_CODE(instance.getString("DealCode"));
            aDebtor.setFDEBTOR_DEB_CAT_CODE(instance.getString("DebCatCode"));
            aDebtor.setFDEBTOR_DEB_CLS_CODE(instance.getString("DebClsCode"));
            aDebtor.setFDEBTOR_LYLTY(instance.getString("DebLylty"));
            aDebtor.setFDEBTOR_OUT_DIS(instance.getString("OutDis"));
            aDebtor.setFDEBTOR_REM_DIS(instance.getString("RemDis"));
            aDebtor.setFDEBTOR_TRAN_BATCH(instance.getString("TranBatch"));
