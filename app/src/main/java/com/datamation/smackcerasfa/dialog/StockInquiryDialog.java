...
import com.datamation.smackcerasfa.adapter.StockInquiryAdaptor;
...
import com.datamation.smackcerasfa.model.TourHed;
...
public class StockInquiryDialog
{
    ...
    public StockInquiryDialog(final Context context) {
        ...
        if (new LocationsController(context).getCurrentLocCode().trim().equalsIgnoreCase("") )
        {
            LocCode = "HO";
        }
        else
        {
            LocCode = new LocationsController(context).getCurrentLocCode().trim();
        }
