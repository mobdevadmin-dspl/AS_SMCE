package com.datamation.smackcerasfa.fragment.debtorlist;
...
import com.datamation.smackcerasfa.adapter.CustomerAdapter;
...
import com.datamation.smackcerasfa.customer.NewCustomerActivity;
...
// comment by MMS - 2021/02/01 - unnecessary dialog

//                        if (debtor.getCusImage() == null || debtor.getCusImage().isEmpty()) {
