package com.datamation.smackcerasfa.fragment.debtordetails;
...
//        }
    ...
    private static class ViewHolder {
        LinearLayout layout;
        com.datamation.smackcerasfa.utils.CustomFont invoiceId;
        com.datamation.smackcerasfa.utils.CustomFont invoiceDate;
        com.datamation.smackcerasfa.utils.CustomFont invoiceAmt;
        com.datamation.smackcerasfa.utils.CustomFont invoiceBalance;
        com.datamation.smackcerasfa.utils.CustomFont invoiceDays;
    }
    ...
    private class OutletOutstandingAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                viewHolder.invoiceId = (com.datamation.smackcerasfa.utils.CustomFont) convertView.findViewById(R.id.row_refno);
                viewHolder.invoiceDate = (com.datamation.smackcerasfa.utils.CustomFont) convertView.findViewById(R.id.row_txndate);
                viewHolder.invoiceAmt = (com.datamation.smackcerasfa.utils.CustomFont) convertView.findViewById(R.id.row_dueAmt);
                viewHolder.invoiceBalance = (com.datamation.smackcerasfa.utils.CustomFont) convertView.findViewById(R.id.row_Amt);
                viewHolder.invoiceDays = (com.datamation.smackcerasfa.utils.CustomFont) convertView.findViewById(R.id.days);
