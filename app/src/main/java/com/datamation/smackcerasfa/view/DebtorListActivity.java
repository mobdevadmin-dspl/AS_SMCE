...
import com.datamation.smackcerasfa.fragment.debtorlist.AllCustomerFragment;
import com.datamation.smackcerasfa.fragment.debtorlist.RouteCustomerFragment;
...
//        });
    ...
    private class DebtorListPagerAdapter extends FragmentPagerAdapter {
        ...
        private final String[] titles = {"ROUTE CUSTOMERS", "ALL CUSTOMERS"};
