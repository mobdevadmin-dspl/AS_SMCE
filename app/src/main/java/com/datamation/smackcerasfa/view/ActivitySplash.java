...
import com.datamation.smackcerasfa.utils.GetMacAddress;
            ...
            public void onClick(View v) {
                if (NetworkUtil.isNetworkAvailable(ActivitySplash.this)){
                    ...
                    if (Patterns.WEB_URL.matcher(URL).matches()) {
                        ...
                        new Validate(pref.getMacAddress().trim(),URL,getString(R.string.SQL_db)).execute();
                        isValidate = false;
...
//                                Log.d(TAG, "onClick: %%%"+pref.getMacAddress().trim());
//
