...
import com.datamation.smackcerasfa.model.HistoryDetail;
import com.datamation.smackcerasfa.model.Invoice;
...
import static com.datamation.smackcerasfa.helpers.DatabaseHelper.DEBCODE;
...
public class CustomerController {
    ...
    public void InsertOrReplaceDebtor(ArrayList<Debtor> list) {
        ...
        try {
            ...
            String sql = "INSERT OR REPLACE INTO " + Customer.TABLE_FDEBTOR + " (DebCode,DebName,DebAdd1,DebAdd2,DebAdd3,DebTele,DebMob,DebEMail,TownCode,AreaCode,DbGrCode,Status,CrdPeriod,ChkCrdPrd,CrdLimit,ChkCrdLmt,RepCode,PrillCode,RankCode,AddMach,AddUser,DealCode,DebCatCode,DebClsCode,DebLylty,OutDis,RemDis,TranBatch,Latitude,Longitude,CusImage) "
                    + " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            ...
            for (Debtor debtor : list) {
                ...
                stmt.bindString(19, debtor.getFDEBTOR_RANK_CODE());
                stmt.bindString(20, debtor.getFDEBTOR_ADD_MACH());
                stmt.bindString(21, debtor.getFDEBTOR_ADD_USER());
                stmt.bindString(22, debtor.getFDEBTOR_DEAL_CODE());
                stmt.bindString(23, debtor.getFDEBTOR_DEB_CAT_CODE());
                stmt.bindString(24, debtor.getFDEBTOR_DEB_CLS_CODE());
                stmt.bindString(25, debtor.getFDEBTOR_LYLTY());
                stmt.bindString(26, debtor.getFDEBTOR_OUT_DIS());
                stmt.bindString(27, debtor.getFDEBTOR_REM_DIS());
                stmt.bindString(28, debtor.getFDEBTOR_TRAN_BATCH());
                stmt.bindString(29, debtor.getFDEBTOR_LATITUDE());
                stmt.bindString(30, debtor.getFDEBTOR_LONGITUDE());
                stmt.bindString(31, debtor.getFDEBTOR_IMG_URL());
