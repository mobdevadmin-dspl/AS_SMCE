    ...
    public int createOrUpdateFControl(ArrayList<Control> coList) {
        ...
        try {
            ...
            for (Control control : coList) {
                ...
                values.put(FCONTROL_CONAGE13, control.getFCONTROL_CONAGE13());//    values.pur.FCONTROL_COMDISPER, control.getFCONTROL_COMDISPER());
                values.put(FCONTROL_CONAGE14, control.getFCONTROL_CONAGE14());
                values.put(FCONTROL_SALESACC, control.getFCONTROL_SALESACC());
